...
#
# Generated by export_simulation on Tue Jun 14 14:53:50 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './data_clk_gen.sh' script.

./data_clk_gen.sh -reset_run
...
./data_clk_gen.sh -noclean_files

For more information on the script, please type './data_clk_gen.sh -help'.
