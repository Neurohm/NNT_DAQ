...
REM
REM Generated by Vivado on Fri Jun 24 18:34:35 -0400 2022
...
echo "xvlog --incr --relax -prj ADC_SPI_Control_vlog.prj"
call xvlog  --incr --relax -prj ADC_SPI_Control_vlog.prj -log xvlog.log
